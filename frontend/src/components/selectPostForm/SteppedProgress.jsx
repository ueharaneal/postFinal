  ...
  return (
    <div className="px-4 py-14 bg-white">
      <div className="p-8 bg-white shadow-lg rounded-md w-full max-w-2xl mx-auto">
        ...
        <div className="flex justify-center items-center p-2 my-6 min-h-[500px] min-w-[500px] bg-gray-100 border-2 border-dashed border-gray-200 rounded-lg">
          {stepContent}
        </div>
