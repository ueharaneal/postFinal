...
const RegisterForm = () => {
  return (
    <section className="grid  grid-cols-1 bg-slate-50 md:grid-cols-[1fr,_400px] lg:grid-cols-[1fr,_600px]">
      <Form />
      <SupplementalContent />
    </section>
  );
...
const SupplementalContent = () => {
  return (
    <div className="group sticky top-4 m-4 h-60 overflow-hidden rounded-3xl rounded-tl-[4rem] bg-slate-950 md:h-100">
      <img
